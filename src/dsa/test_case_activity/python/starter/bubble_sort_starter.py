...
class BubbleSortStarter:
    def bubble_sort(self, scores):
        ...
        Returns:
            A new sorted list (don't modify the original)
        """
        # TODO: Implement bubble sort algorithm
        # Hint: Create a copy of the list first (don't modify original)
        # Use nested loops:
        #   - Outer loop: number of passes (len(scores) - 1)
        #   - Inner loop: compare adjacent elements (len(scores) - 1 - i)
        ...
        #             # Swap sorted_scores[j] and sorted_scores[j + 1]
        
        return sorted_scores  # Return the sorted list
