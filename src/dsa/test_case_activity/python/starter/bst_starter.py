...
class Node:
    def __init__(self, product_id):
        # TODO: Initialize node with product_id, left, and right
        # Hint: left and right should be None initially
...
class BSTStarter:
    ...
    def _insert_helper(self, node, product_id):
        ...
        Hint: If node is None, create new Node
        If product_id < node.product_id, go left
        If product_id > node.product_id, go right
        Return the node (or new node if None)
    ...
    def _search_helper(self, node, product_id):
        ...
        Hint: If node is None, return False
        If product_id == node.product_id, return True
        If product_id < node.product_id, search left
        If product_id > node.product_id, search right
...
#
# 1. Insert: [Your explanation here]
# 2. Search: [Your explanation here]
#
